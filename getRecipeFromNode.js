...
unirest.get("https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/random?limitLicense=false&number=45")
    .header("X-Mashape-Key", "2HS3QW2ddJmshmp1P69T5wIg21Wap1bULZxjsnMxKtafayYhn1")
    .header("Accept", "application/json")
    .end(function (result) {
      fs.writeFile('jsonfile.json', JSON.stringify(result))
    });